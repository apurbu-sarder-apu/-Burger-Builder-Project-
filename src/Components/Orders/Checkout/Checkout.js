...
class Checkout extends Component {
    ...
    submitHandler = () => {
        ...
        axios.post("https://burger-builder-project-3cfe7-default-rtdb.firebaseio.com/orders.json", order)
        .then(response => {
    ...
    render() {
        let form = (<div>
            ...
            <form style={{
                ...
                value={this.state.values.deliveryAddress} placeholder="Your Address"
                onChange={(e)=> this.inputChangeHandler(e)}></textarea>
                <br />
                <input 
                name="phone" 
                className="form-control"
                value={this.state.values.phone} placeholder="Your Phone Number"
